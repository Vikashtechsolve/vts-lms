      ...
      <div className="flex-1 px-5 sm:px-8 md:px-10 py-8 md:py-10">
        ...
        {items.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
            {items.map((it) => (
              <div key={it.id} className="bg-[#161616] w-80 border border-[#242424] rounded-xl overflow-hidden">
                <img src={it.thumbnail} alt={it.title} className="w-full h-44 object-cover" />
                <div className="p-4 flex  gap-22">
                  <h3 className="text-white font-semibold text-left text-sm mb-2">{it.title}</h3>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <button
                      ...
                      className="text-xs px-3 py-1 rounded bg-[#2a2a2a] border border-[#3b3b3b]"
                    >
                      Remove
                    </button>
                  </div>
