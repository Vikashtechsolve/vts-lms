...
export default function StudentProgress() {
  return (
    <div className="flex bg-black min-h-screen text-left">
...
<p className="text-gray-400 text-[14px] mb-8">
          Track your course completion, quiz performance, and overall learning milestones
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-[#141414] p-5 rounded-xl shadow border border-white/10">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-[17px] font-medium">All Courses Progress</h2>
            </div>

            <p className="text-gray-300 text-[14px] mb-2">Your Progress Bar : 92%</p>

            <div className="w-full bg-gray-700 h-3 rounded-full">
              <div className="bg-red-500 h-3 rounded-full" style={{ width: "92%" }}></div>
            </div>
          ...
          <div className="bg-[#141414] p-5 rounded-xl shadow border border-white/10">
            ...
            <h1 className="text-[22px] font-semibold mb-1">12 Modules Completed</h1>
          ...
          <div className="bg-[#141414] p-5 rounded-xl shadow border border-white/10">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-[17px] font-medium">Master Classes Attended</h2>
            </div>

            <h1 className="text-[22px] font-semibold mb-1">5 Master Classes Done</h1>
            <p className="text-gray-400 text-[13px]">Last Master Class : 3 Days ago</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
          ...
          <div className="bg-[#141414] p-5 rounded-xl shadow border border-white/10">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-[17px] font-medium">Total Quizzes Attempt</h2>
            </div>

            <h1 className="text-[22px] font-semibold mb-1">12 Quizzes Attempted</h1>
            <p className="text-gray-400 text-[13px]">Last Quiz : 3 Days ago</p>
          </div>
          ...
          <div className="bg-[#141414] p-5 rounded-xl shadow border border-white/10">
            ...
            <h1 className="text-[22px] font-semibold mb-1">8 Badges Earned</h1>
